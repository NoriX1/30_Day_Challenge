...
document.querySelector('#button').addEventListener('click', (e) => category.classList.toggle('hide'));
...
const alphabetically = people.sort((a, b) => {
  const [lastNameFirst] = a.split(', ')[1];
  const lastNameSecond = b.split(', ')[1];
  return lastNameFirst > lastNameSecond ? 1 : -1;
  // const [aFisrt, aSecond] = a.split(', ');
